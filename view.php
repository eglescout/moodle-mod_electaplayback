...
$PAGE->set_url('/mod/electaplayback/view.php', array('id' => $cm->id));

// Make sure eLecta Playback exists before generating output
...
// For 'play' links, we always redirect to the content  - 
// the redirection is needed for completion tracking and logging
$fullelectaplayback = electaplayback_get_playable_url($electaplayback);
